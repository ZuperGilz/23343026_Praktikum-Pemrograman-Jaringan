...
const forecast = (latitude, longitude, callback) => {
    const url = 'http://api.weatherstack.com/current?access_key=e2419709f064ad9d19f80a17ae7f935d&query=' +
    ...
    request({ url: url, json: true }, (error, response) => {
        if (error) {
            ...
            callback(undefined,
                ...
                'Suhu saat ini ' + response.body.current.temperature + '°C. ' +
                'Index UV ' + response.body.current.uv_index + '. ' +
